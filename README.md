...
`npm run build` creates `dist/social-network-timer-x.x.x.zip` for Chrome Web Store upload. No Node third-party dependencies required; build uses the system `zip` command.
